const LEGAL = {
  ...
  doing: new Set(["done", "pending_acceptance", "blocked", "deferred", "cancelled"]),
  pending_acceptance: new Set(["done", "doing", "cancelled"]),
...
const ACTIONS = {
  ...
  request_acceptance: { target: "pending_acceptance", kind: "acceptance_requested" },
  accept: { target: "done", kind: "task_accepted" },
  reject: { target: "doing", kind: "task_rejected" },
